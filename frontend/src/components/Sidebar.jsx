...
function Sidebar() {
  const links = [
    { to: '/dashboard', label: 'OPERATIONAL STATUS',    icon: LayoutDashboard },
    { to: '/upload',    label: 'DOCUMENT INGESTION',    icon: UploadCloud     },
    { to: '/analyze',   label: 'INTEL ANALYSIS',        icon: FileSearch      },
    { to: '/chat',      label: 'AGENT QUERY TERMINAL',  icon: Terminal        },
    { to: '/logs',      label: 'AUDIT LOGS',            icon: ShieldAlert     },
    { to: '/settings',  label: 'SYSTEM CONFIGURATION',  icon: Cpu             },
  ];
